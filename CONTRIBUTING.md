...
**Node 版本**：本地与生产运行时均为 Node 25.9.0。`engines.node` 声明为 `^22.22.2 || ^24.15.0 || ^25.9.0 || >=26.0.0`，请勿随意升级主版本。完整运行时矩阵与 jsdom@30 的 advisory 例外见 [docs/0814/node-runtime-matrix.md](docs/0814/node-runtime-matrix.md)。
