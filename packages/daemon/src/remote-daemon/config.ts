...
Usage:
  ...
  dofe-agent-daemon verify-deepseek-release
  dofe-agent-daemon verify-deepseek-model-canary
...
Environment:
  ...
  DOFE_AGENT_DEEPSEEK_RUNTIME_IMAGE_DIGEST
  DOFE_AGENT_DEEPSEEK_COSIGN_PUBLIC_KEY_SHA256
  DOFE_AGENT_DEEPSEEK_MODEL_CANARY_TIMEOUT_MS
