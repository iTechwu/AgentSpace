  ...
  try {
    ...
    writeExecutable(
      ...
      [
        ...
        "    send({ jsonrpc: '2.0', id: message.id, result: { serverInfo: { name: 'deepseek-harness-sdk-runtime', version: '0.0.1' }, protocolVersion: '2.0' } });",
        "    return;",
        "  }",
  ...
  try {
    ...
    writeExecutable(
      ...
      [
        ...
        "  const message = JSON.parse(line);",
        "  if (message.method === 'initialize') {",
        "    process.stdout.write(`${JSON.stringify({ jsonrpc: '2.0', id: message.id, result: { serverInfo: { name: 'deepseek-harness-sdk-runtime', version: '0.0.1' }, protocolVersion: '2.0' } })}\\n`);",
        "    return;",
        "  }",
        "  if (message.method === 'session/prompt') {",
  ...
  try {
    writeExecutable(
      ...
      [
        ...
        "  if (request.method === 'initialize') process.stdout.write(JSON.stringify({ jsonrpc: '2.0', id: request.id, result: { serverInfo: { name: 'deepseek-harness-sdk-runtime', version: '0.0.1' }, protocolVersion: '2.0' } }) + '\\n');",
