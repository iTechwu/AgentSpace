...
// Lock computation lives in release-lock.ts so installations.ts can depend on
// it without importing this module (which imports installation builders back).
export {
  computeSkillReleaseLockInternal,
  computeSkillReleaseLockSync,
  computeLegacyLockDigest,
  parseManifest,
  SKILL_PROVIDER_COMPATIBILITY_REVISION,
  type ResolvedSkillReleaseLock,
} from "./release-lock.ts";
import {
  computeSkillReleaseLockInternal,
  computeSkillReleaseLockSync,
  computeLegacyLockDigest,
