...
export interface ExternalDocumentProviderAdapter {
    ...
    resolveResource(context: IntegrationRuntimeContext, resourceUrlOrToken: string): Promise<ExternalResourceDescriptor | null> | ExternalResourceDescriptor | null;
    executeOperation?(context: IntegrationRuntimeContext, request: ExternalDataOperationRequest): Promise<ExternalDataOperationResult> | ExternalDataOperationResult;
}
