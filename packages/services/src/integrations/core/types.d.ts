import type { ExternalDataOperationActorType, ExternalIntegrationHealthStatus, ExternalIntegrationProvider, ExternalIntegrationTransportMode, ExternalResourceBindingProviderType } from "@agent-space/db";
