...
// Re-exported here so existing `from "./data-plane.ts"` importers stay stable;
// the constant itself lives in data-operation-descriptors.ts to avoid a
// data-plane ↔ operation-plan import cycle.
export { FEISHU_DATA_OPERATION_DESCRIPTORS } from "./data-operation-descriptors.ts";
