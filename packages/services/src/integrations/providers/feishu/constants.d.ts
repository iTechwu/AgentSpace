...
export declare const FEISHU_OPENAPI_REQUIRED_LIVE_SMOKE_STEPS: readonly ["Client im.message.create", "DofeAgent callback URL verification", "Tenant access token", "Docs docx metadata", "Docs docx read blocks", "Docs docx append blocks", "Sheets metadata", "Sheets read values", "Sheets write values", "Base list tables", "Base list records", "Base update record"];
