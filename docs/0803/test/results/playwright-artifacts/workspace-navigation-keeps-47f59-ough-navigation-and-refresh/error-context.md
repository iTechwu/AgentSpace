...
- dialog "新手引导":
  ...
  - button "下一步"
- complementary "工作区导航":
  - button "切换团队工作区": E2E Workspace msdctno2-oausxs
  ...
  - list:
    - listitem:
      - link "打开任务 1":
        - /url: /w/sso-team-e2e-msdctno2-oausxs/task/board
        - text: 打开任务
        - strong: "1"
    - listitem:
      - link "待审批":
        - /url: /w/sso-team-e2e-msdctno2-oausxs/approvals
    - listitem:
      - link "知识页":
        - /url: /w/sso-team-e2e-msdctno2-oausxs/knowledge
  - heading "协作" [level=2]
  - link "通知":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/inbox
  - link "消息 3":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/im
  - link "联系人 1":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/contacts
  - heading "数字员工" [level=2]
  - link "员工管理 1":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/agents?mode=agent
  - link "数字员工展板 1":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/agents?mode=showcase
  - link "执行引擎管理":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/runtimes
  - heading "能力资源" [level=2]
  - link "技能库 6":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/skills
  - link "知识库":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/knowledge
  - link "应用市场":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/market
  - link "审计日志":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/audit
  - link "打开设置":
    - /url: /w/sso-team-e2e-msdctno2-oausxs/settings
    - strong: E2E Owner msdctno2-oausxs
    - text: 超级管理员
  - button "退出登录"
- main:
  - text: 数字员工
