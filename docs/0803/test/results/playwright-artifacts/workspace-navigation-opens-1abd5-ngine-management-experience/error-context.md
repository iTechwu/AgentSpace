...
```yaml
- complementary "工作区导航":
  - button "切换团队工作区": E2E Workspace msdcttxh-5iw4dz
  ...
  - list:
    - listitem:
      - link "打开任务 1":
        - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/task/board
        - text: 打开任务
        - strong: "1"
    - listitem:
      - link "待审批":
        - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/approvals
    - listitem:
      - link "知识页":
        - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/knowledge
  - heading "协作" [level=2]
  - link "通知":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/inbox
  - link "消息 3":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/im
  - link "联系人 1":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/contacts
  - heading "数字员工" [level=2]
  - link "员工管理 1":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/agents?mode=agent
  - link "数字员工展板 1":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/agents?mode=showcase
  - link "执行引擎管理":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/runtimes
  - heading "能力资源" [level=2]
  - link "技能库 6":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/skills
  - link "知识库":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/knowledge
  - link "应用市场":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/market
  - link "审计日志":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/audit
  - link "打开设置":
    - /url: /w/sso-team-e2e-msdcttxh-5iw4dz/settings
    - strong: E2E Owner msdcttxh-5iw4dz
    - text: 超级管理员
  - button "退出登录"
- main:
  - text: 数字员工
