...
上游 wire 扩展已先落地 session cancel/resume/approval-policy/per-session endpoint overlay 与版本协商；下一阶段只在真实 carrier 验证后补 turn cancel ACK、逐请求 approval、session close，再实现 AgentSpace 的 bounded connection manager。
