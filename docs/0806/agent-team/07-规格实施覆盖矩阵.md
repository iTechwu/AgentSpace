...
代码证据：本轮复审基线 `dcb21558`，最终范围以本目录所在已提交版本为准
...
| ID | 门禁 | 状态 | 已有证据 | 关闭条件 |
| --- | --- | --- | --- | --- |
| T01 | Domain/Service/Web/Worker 定向测试 | `DONE` | 2026-08-07：Domain 37 项、Workflow Service 23 项、Feishu Outbound 26 项、Web Completion/Reconcile/Cron 18 项、CLI Completion/Client 6 项及部署/发布配置 9 项通过 | 数据库、TOS 与浏览器链路分别由 T03/T04 管理 |
