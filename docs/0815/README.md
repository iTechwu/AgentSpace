...
> 状态：已部分实现（`7f360d27..585ab010`），审查发现验收差距并经独立复核确认，见 [07-验收审查与差距](./07-验收审查与差距.md)
>
...
| [07-验收审查与差距.md](./07-验收审查与差距.md) | 实现 vs 验收清单的差距审查（P1/P2/Standards + 验证结果） |
| [08-审批安全边界设计取舍.md](./08-审批安全边界设计取舍.md) | P1-2/P1-3 审批安全边界（UNIQUE vs 非唯一）决策与落地 |
