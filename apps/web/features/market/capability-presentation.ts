...
export function runtimeAppInstallabilityReason(
  ...
  switch (code) {
    ...
    case "runtime_app.artifact_integrity_missing":
      return tx("私有 release 缺少可验证的 artifact 地址或完整性摘要，请重新发布。", "The private release has no verifiable artifact URL or integrity digest. Publish it again.");
