import { failSkillInstallationOperationSync, parseFailSkillInstallationOperationPayload } from "@dofe-agent/services/skills";
...
export async function POST(
  ...
  const parsed = parseFailSkillInstallationOperationPayload(body.value);
  if (!parsed.ok) {
